...
def _get_repo_and_remote(lib_path: StrPath, remote_name: str = "origin") -> Tuple[git.repo.Repo, git.Remote]:
...
def sync_repo(lib_path: StrPath, remote_name: str = "origin", branch_name: str = "main") -> None:
    """
...
def commit_changes(lib_path: StrPath, message:str, remote_name: str = "origin", skip_hooks: bool = True) -> None:
...
def sync_commit_push(message: str, *, remote_name: str = "origin", branch_name: str = "main", skip_hooks: bool = True):
    """
